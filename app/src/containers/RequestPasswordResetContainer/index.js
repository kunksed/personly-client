...
class RequestPasswordResetContainer extends Component {
  ...
  componentDidMount() {
    ...
    if (this.props.location.query.token) {
      ...
      axiosGitHubGraphQL
        .post(`${process.env.NODE_ENV === 'development' ? 'https://personly-api.herokuapp.com/graphql' : `${process.env.NODE_ENV === 'development' ? 'https://personly-api.herokuapp.com/graphql' : 'https://personly-api.herokuapp.com/graphql'}`}`, { query: MAIN_QUERY })
        .then(result => {
